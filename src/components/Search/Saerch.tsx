...
export const Search: React.FC<Props> = ({ value, setSearchQuery }) => {
  return (
    <div className="search">

      <label
        htmlFor="search__input"
        className="search__lable"
      >
        <svg className="search__icon" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
